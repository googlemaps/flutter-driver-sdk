...
const String _lmfsiOSBaseUrl = String.fromEnvironment(
  'LMFS_IOS_HOST_URL',
...
Future<LMFSManifest> initLMFSBackendForVehicle({
  ...
  required List<NavigationWaypoint> stopWaypoints,
}) async {
  final String clientId = getClientId();
  assert(
    deliveryWaypoints.length == stopWaypoints.length,
...
Future<LMFSManifest> completeFirstLMFSStop(LMFSManifest manifest) async {
  ...
  final LMFSManifestUpdate update = LMFSManifestUpdate(
